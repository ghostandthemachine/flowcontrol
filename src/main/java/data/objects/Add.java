...
public class Add extends DataNode {
    ...
    public Add(String t, VisualNode parent, DataScene ds) {
        super(" +     ", parent,ds, 2, 1);
        setInputs();
    }

    public Add(String t, VisualNode parent, DataScene ds, int i) {
        super(" +    " + Integer.toString(i),parent, ds, 2, 1);
        intAddition = i;
        setInputs();
    }

    public Add(String t, VisualNode parent, DataScene ds, float f) {
