 ...
 * @author David Kaspar
 */
public final class CustomInplaceTextEditorAction<C extends JComponent> extends WidgetAction.LockedAdapter implements InplaceEditorProvider.TypedEditorController {
    ...
    public CustomInplaceTextEditorAction(InplaceEditorProvider<C> provider) {
