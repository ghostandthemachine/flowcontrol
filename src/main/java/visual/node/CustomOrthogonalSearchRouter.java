 ...
 * @author David Kaspar
 */
public final class CustomOrthogonalSearchRouter implements Router {

    static final int SPACING_EDGE = 16;
    ...
    public CustomOrthogonalSearchRouter (CollisionsCollector collector) {
        this.collector = collector;
    }

    public CustomOrthogonalSearchRouter (ConnectionWidgetCollisionsCollector collector) {
    ...
    public java.util.List<Point> routeConnection(ConnectionWidget widget) {
        ...
        for (Anchor.Direction sourceDirection : sourceDirections) { //up to four choices (TOP, BOTTOM, RIGHT, LEFT)
            ...
            for (Anchor.Direction targetDirection : targetDirections) {//up to four choices (TOP, BOTTOM, RIGHT, LEFT)
                ...
                Solution solution =
                        new CustomOrthogonalSearchRouterCore(widget.getScene(),
        ...
        //re-route
        if (sourceAnchor.allowsArbitraryConnectionPlacement() || targetAnchor.allowsArbitraryConnectionPlacement()) {
            bestSolution = new CustomOrthogonalSearchRouterCore(widget.getScene(),
                    verticalCollisions, horizontalCollisions,
