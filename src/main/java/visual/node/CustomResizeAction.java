 ...
 * @author David Kaspar
 */
public final class CustomResizeAction extends WidgetAction.LockedAdapter {
    ...
    public CustomResizeAction (ResizeStrategy strategy, ResizeControlPointResolver resolver, ResizeProvider provider) {
        this.strategy = strategy;
        this.resolver = resolver;
        this.provider = provider;
    }

    public CustomResizeAction() {

        this.strategy = ActionFactory.createFreeResizeStategy ();
        this.resolver = ActionFactory.createDefaultResizeControlPointResolver ();
        this.provider = ActionFactory.createDefaultResizeProvider();
    }
    ...
    private boolean resize (Widget widget, Point newLocation) {
        ...
        switch (controlPoint) {
            ...
            case CENTER_LEFT:
                ...
                break;
            case CENTER_RIGHT:
                resizeToRight (200, rectangle, dx);
                break;
            case TOP_CENTER:
